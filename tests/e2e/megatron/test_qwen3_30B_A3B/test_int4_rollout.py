...
register_amd_ci(est_time=1800, suite="stage-c-4-gpu-mi35x", labels=["megatron"], disabled="INT4 quant kernel is CUDA-only (no ROCm/HIP build of fake_int_quant_cuda)")
