...
register_cuda_ci(est_time=1500, suite="stage-c-8-gpu-h100", labels=["megatron"])
register_amd_ci(est_time=1500, suite="stage-c-8-gpu-mi35x", labels=["megatron"], disabled="Deep-EP is WIP on ROCm")
