...
def miles_validate_args(args):
    ...
    if args.colocate:
        ...
        if args.offload_rollout is None:
            args.offload_rollout = True
        if getattr(args, "sglang_enable_piecewise_cuda_graph", False):
            logger.warning("Warning: colocate mode with --sglang-enable-piecewise-cuda-graph may trigger NVLS OOM.")
